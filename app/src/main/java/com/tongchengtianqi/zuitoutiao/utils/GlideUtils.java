...
public class GlideUtils {
    ...
    //设置预加载图片
    public static void loadPreloadImageView(Context mContext, String path, ImageView mImageView,int id) {
        Glide.with(mContext).load(path).placeholder(id).into(mImageView);
    }
