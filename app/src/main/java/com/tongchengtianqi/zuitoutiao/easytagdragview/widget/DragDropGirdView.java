...
import com.tongchengtianqi.zuitoutiao.easytagdragview.listener.OnDragDropListener;
...
public class DragDropGirdView extends GridView implements OnDragDropListener,
    ...
    private boolean mIsFixedHeight = true;
    ...
    public DragDropGirdView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAnimationDuration = ta.getInteger(R.styleable.DragDropGirdView_anim_duration,
                context.getResources().getInteger(R.integer.fade_duration));
        ta.recycle();
